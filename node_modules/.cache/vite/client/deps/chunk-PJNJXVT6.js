...
function x(n, l) {
  const g = JSON.parse(n, l == null ? void 0 : l.reviver);
  return N(n, g, l), g;
}
function z(n, l) {
  const g = C(n, l), e = JSON.stringify(n, l == null ? void 0 : l.replacer, g.indent);
  return g.whitespace.start + e + g.whitespace.end;
}
function h(n, l) {
  const g = K(n, l == null ? void 0 : l.errors, l);
  return N(n, g, l), g;
}
function d(n, l) {
  return z(n, l);
...
//# sourceMappingURL=chunk-PJNJXVT6.js.map
