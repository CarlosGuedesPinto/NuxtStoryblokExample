...
var sysPath2 = __toESM(require_path());
...
var ReaddirpStream = class extends import_stream.Readable {
  ...
  async _formatEntry(dirent, path) {
    ...
    try {
      const fullPath = (0, import_path.resolve)((0, import_path.join)(path, basename3));
      entry = { path: (0, import_path.relative)(this._root, fullPath), fullPath, basename: basename3 };
...
var sysPath = __toESM(require_path(), 1);
...
*/
//# sourceMappingURL=esm-YAQUZCCP.js.map
