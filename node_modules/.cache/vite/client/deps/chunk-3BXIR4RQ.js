...
function x(e, t = {}) {
  var _a, _b;
  const n = t.indent === void 0 && t.preserveIndentation !== false && e.slice(0, (t == null ? void 0 : t.sampleSize) || 1024), i = t.preserveWhitespace === false ? void 0 : { start: ((_a = k.exec(e)) == null ? void 0 : _a[0]) || "", end: ((_b = v.exec(e)) == null ? void 0 : _b[0]) || "" };
...
function C(e, t) {
  if (!e || typeof e != "object" || !(m in e)) return { indent: t == null ? void 0 : t.indent, whitespace: { start: "", end: "" } };
  const n = e[m];
  return { indent: (t == null ? void 0 : t.indent) || _(n.sample || "").indent, whitespace: n.whiteSpace || { start: "", end: "" } };
}
...
//# sourceMappingURL=chunk-3BXIR4RQ.js.map
