...
var S = (l, e, t) => e in l ? w(l, e, { enumerable: true, configurable: true, writable: true, value: t }) : l[e] = t;
...
function x(l, e, t) {
  ...
  return a.abort = () => {
    n = true, s.forEach(clearTimeout), s = [], r.forEach(
...
var re = class {
  ...
  render(e, t = { optimizeImages: false }, r = true) {
    ...
    ), $ = true), e && e.content && Array.isArray(e.content)) {
      let s = "";
...
var ie = class {
  constructor(e) {
    ...
    c(this, "parameters");
    c(this, "fetchOptions");
    this.baseURL = e.baseURL, this.headers = e.headers || new Headers(), this.timeout = e != null && e.timeout ? e.timeout * 1e3 : 0, this.responseInterceptor = e.responseInterceptor, this.fetch = (...t) => e.fetch ? e.fetch(...t) : fetch(...t), this.ejectInterceptor = false, this.url = "", this.parameters = {}, this.fetchOptions = {};
  }
  /**
   *
   * @param url string
...
var ae = class {
  ...
  constructor(e, t) {
    ...
    let r = e.endpoint || t;
    if (!r) {
      const n = new m().getRegionURL, o = e.https === false ? "http" : "https";
    ...
    e.oauthToken && (s.set("Authorization", e.oauthToken), i = 3), e.rateLimit && (i = e.rateLimit), e.richTextSchema ? this.richTextResolver = new v(e.richTextSchema) : this.richTextResolver = new v(), e.componentResolver && this.setComponentResolver(e.componentResolver), this.maxRetries = e.maxRetries || 10, this.retriesDelay = 300, this.throttle = x(
      ...
      i,
      1e3
    ), this.accessToken = e.accessToken || "", this.relations = {}, this.links = {}, this.cache = e.cache || { clear: "manual" }, this.helpers = new m(), this.resolveCounter = 0, this.resolveNestedRelations = e.resolveNestedRelations || true, this.stringifiedStoriesCache = {}, this.client = new ne({
      baseURL: r,
      timeout: e.timeout || 0,
      headers: s,
...
//# sourceMappingURL=storyblok-js-client.js.map
