...
var F = (i) => new Promise((e, t) => {
  ...
  s.async = true, s.src = i, s.id = "storyblok-javascript-bridge", s.onerror = (r) => t(r), s.onload = (r) => {
    U.forEach((o) => o()), H = true, e(r);
  }, document.getElementsByTagName("head")[0].appendChild(s);
});
var Q = Object.defineProperty;
var Z = (i, e, t) => e in i ? Q(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var p = (i, e, t) => Z(i, typeof e != "symbol" ? e + "" : e, t);
...
function te(i, e, t) {
  ...
  return a.abort = () => {
    n = true, r.forEach(clearTimeout), r = [], s.forEach(
...
var xe = class {
  ...
  render(e, t = { optimizeImages: false }, s = true) {
    if (!z && s && (console.warn(
...
var Le = class {
  ...
  constructor(e, t) {
    ...
    let s = e.endpoint || t;
    if (!s) {
      const n = new A().getRegionURL, l = e.https === false ? "http" : "https";
    ...
    e.oauthToken && (r.set("Authorization", e.oauthToken), o = 3), e.rateLimit && (o = e.rateLimit), e.richTextSchema ? this.richTextResolver = new L(e.richTextSchema) : this.richTextResolver = new L(), e.componentResolver && this.setComponentResolver(e.componentResolver), this.maxRetries = e.maxRetries || 10, this.retriesDelay = 300, this.throttle = te(
      ...
      o,
      1e3
    ), this.accessToken = e.accessToken || "", this.relations = {}, this.links = {}, this.cache = e.cache || { clear: "manual" }, this.helpers = new A(), this.resolveCounter = 0, this.resolveNestedRelations = e.resolveNestedRelations || true, this.stringifiedStoriesCache = {}, this.client = new Ae({
      baseURL: s,
      timeout: e.timeout || 0,
      headers: r,
...
var $ = ((i) => (i.DOCUMENT = "doc", i.HEADING = "heading", i.PARAGRAPH = "paragraph", i.QUOTE = "blockquote", i.OL_LIST = "ordered_list", i.UL_LIST = "bullet_list", i.LIST_ITEM = "list_item", i.CODE_BLOCK = "code_block", i.HR = "horizontal_rule", i.BR = "hard_break", i.IMAGE = "image", i.EMOJI = "emoji", i.COMPONENT = "blok", i))($ || {});
var T = ((i) => (i.BOLD = "bold", i.STRONG = "strong", i.STRIKE = "strike", i.UNDERLINE = "underline", i.ITALIC = "italic", i.CODE = "code", i.LINK = "link", i.ANCHOR = "anchor", i.STYLED = "styled", i.SUPERSCRIPT = "superscript", i.SUBSCRIPT = "subscript", i.TEXT_STYLE = "textStyle", i.HIGHLIGHT = "highlight", i))(T || {});
var G = ((i) => (i.TEXT = "text", i))(G || {});
var I = ((i) => (i.URL = "url", i.STORY = "story", i.ASSET = "asset", i.EMAIL = "email", i))(I || {});
var Pe = [
  "area",
  "base",
  "br",
...
var Ne = (i = {}) => Object.keys(i).map((e) => `${e}="${i[e]}"`).join(" ");
var Me = (i = {}) => Object.keys(i).map((e) => `${e}: ${i[e]}`).join("; ");
function He(i) {
  return i.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
}
var B = (i) => Object.fromEntries(Object.entries(i).filter(([e, t]) => t !== void 0));
function q(i, e = {}, t) {
...
function Be(i = {}) {
  ...
  const {
    ...
    textFn: s = He,
    resolvers: r = {},
    optimizeImages: o = false,
    keyedResolvers: n = false
  } = i, l = t !== q, a = (h) => (g) => {
    const f = g.attrs || {};
    ...
    ...h.attrs,
    key: `code-${e}`
  }, t("code", { key: `code-${e}` }, h.children || "")), y = (h, g = false) => ({ text: f, attrs: k }) => {
    ...
    [T.LINK, j],
    [T.ANCHOR, j],
    [T.STYLED, y("span", true)],
    [T.BOLD, y("strong")],
    [T.TEXT_STYLE, y("span", true)],
    [T.ITALIC, y("em")],
    [T.UNDERLINE, y("u")],
    [T.STRIKE, y("s")],
    [T.CODE, y("code")],
...
var N;
var M = "https://app.storyblok.com/f/storyblok-v2-latest.js";
var qe = (i, e, t = {}) => {
  var l;
...
var Fe = (i = {}) => {
  ...
  return e !== false && u && F(M), N = new L(o.schema), o.resolver && V(N, o.resolver), a;
};
var Ue = (i) => {
  var e;
...
var Ge = (i, e, t) => {
  ...
  return Ue(i) ? "" : (e && (s = new L(e.schema), e.resolver && V(s, e.resolver)), s.render(i, {}, false));
};
var Ve = () => F(M);
export {
  $ as BlockTypes,
...
//# sourceMappingURL=@storyblok_js.js.map
