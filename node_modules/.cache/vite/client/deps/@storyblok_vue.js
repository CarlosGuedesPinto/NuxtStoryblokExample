...
var de = (s) => new Promise((e, t) => {
  ...
  r.async = true, r.src = s, r.id = "storyblok-javascript-bridge", r.onerror = (o) => t(o), r.onload = (o) => {
    z.forEach((n) => n()), D = true, e(o);
  }, document.getElementsByTagName("head")[0].appendChild(r);
});
var pe = Object.defineProperty;
var ge = (s, e, t) => e in s ? pe(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t;
var p = (s, e, t) => ge(s, typeof e != "symbol" ? e + "" : e, t);
...
function fe(s, e, t) {
  ...
  return a.abort = () => {
    i = true, o.forEach(clearTimeout), o = [], r.forEach(
...
var Je = class {
  ...
  constructor(e, t) {
    ...
    let r = e.endpoint || t;
    if (!r) {
      const i = new L().getRegionURL, l = e.https === false ? "http" : "https";
    ...
    e.oauthToken && (o.set("Authorization", e.oauthToken), n = 3), e.rateLimit && (n = e.rateLimit), e.richTextSchema ? this.richTextResolver = new P(e.richTextSchema) : this.richTextResolver = new P(), e.componentResolver && this.setComponentResolver(e.componentResolver), this.maxRetries = e.maxRetries || 10, this.retriesDelay = 300, this.throttle = fe(
      ...
      n,
      1e3
    ), this.accessToken = e.accessToken || "", this.relations = {}, this.links = {}, this.cache = e.cache || { clear: "manual" }, this.helpers = new L(), this.resolveCounter = 0, this.resolveNestedRelations = e.resolveNestedRelations || true, this.stringifiedStoriesCache = {}, this.client = new Ke({
      baseURL: r,
      timeout: e.timeout || 0,
      headers: o,
...
var v = ((s) => (s.DOCUMENT = "doc", s.HEADING = "heading", s.PARAGRAPH = "paragraph", s.QUOTE = "blockquote", s.OL_LIST = "ordered_list", s.UL_LIST = "bullet_list", s.LIST_ITEM = "list_item", s.CODE_BLOCK = "code_block", s.HR = "horizontal_rule", s.BR = "hard_break", s.IMAGE = "image", s.EMOJI = "emoji", s.COMPONENT = "blok", s))(v || {});
var T = ((s) => (s.BOLD = "bold", s.STRONG = "strong", s.STRIKE = "strike", s.UNDERLINE = "underline", s.ITALIC = "italic", s.CODE = "code", s.LINK = "link", s.ANCHOR = "anchor", s.STYLED = "styled", s.SUPERSCRIPT = "superscript", s.SUBSCRIPT = "subscript", s.TEXT_STYLE = "textStyle", s.HIGHLIGHT = "highlight", s))(T || {});
var X = ((s) => (s.TEXT = "text", s))(X || {});
var I = ((s) => (s.URL = "url", s.STORY = "story", s.ASSET = "asset", s.EMAIL = "email", s))(I || {});
var Xe = [
  "area",
  "base",
  "br",
...
var Qe = (s = {}) => Object.keys(s).map((e) => `${e}="${s[e]}"`).join(" ");
var Ze = (s = {}) => Object.keys(s).map((e) => `${e}: ${s[e]}`).join("; ");
function et(s) {
  return s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
}
var q = (s) => Object.fromEntries(Object.entries(s).filter(([e, t]) => t !== void 0));
function V(s, e = {}, t) {
...
function tt(s = {}) {
  ...
  const {
    ...
    ...c.attrs,
    key: `code-${e}`
  }, t("code", { key: `code-${e}` }, c.children || "")), b = (c, g = false) => ({ text: m, attrs: k }) => {
    ...
    [T.LINK, j],
    [T.ANCHOR, j],
    [T.STYLED, b("span", true)],
    [T.BOLD, b("strong")],
    [T.TEXT_STYLE, b("span", true)],
    [T.ITALIC, b("em")],
    [T.UNDERLINE, b("u")],
    [T.STRIKE, b("s")],
    [T.CODE, b("code")],
...
var U;
var G = "https://app.storyblok.com/f/storyblok-v2-latest.js";
var rt = (s, e, t = {}) => {
  var r;
...
var st = (s = {}) => {
  ...
  return r !== false && d && de(G), U = new P(l.schema), l.resolver && Q(U, l.resolver), u;
};
var ot = (s) => {
  var e;
...
var ut = (s, e, t) => {
  ...
  return ot(s) ? "" : (e && (r = new P(e.schema), e.resolver && Q(r, e.resolver)), r.render(s, {}, false));
};
var Z = K({
...
var gt = {
  install(s, e = {}) {
    s.directive("editable", lt), s.component("StoryblokComponent", Z), s.component("StoryblokRichText", at), e.enableFallbackComponent && !e.customFallbackComponent && s.component(
      "FallbackComponent",
      ue(() => import("./FallbackComponent-U_HRL08c-MJBSFA6C.js"))
    );
